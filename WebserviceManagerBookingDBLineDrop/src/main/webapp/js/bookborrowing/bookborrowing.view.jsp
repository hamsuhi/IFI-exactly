						...
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<input type="date" ng-model="ctrl.bookborrowing.dateBorrowing"
									id="uname" class="username form-control input-sm" required
									ng-minlength="3" />
							</div>
						</div>
					</div>
							...
							<div class="col-md-7">
								<select class="form-control"
									...
									<option ng-repeat="p in ctrl.getAllBookings()"							
										ng-selected="ctrl.bookborrowing.booking.bookingId == p.bookingId" value="{{p.bookingId}}">{{p.bookName}}</option>
	...
	<table class="table table-hover">
		...
		<tbody>
			<tr ng-repeat="p in ctrl.getAllBookBorrowings()">
				...
				<td>{{p.booking.bookName}}</td>
				<td>{{p.reader.fullName}}</td>
