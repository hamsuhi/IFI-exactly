<div class="container">
	<div class="panel panel-default">
        ...
        <div class="panel-heading"><span class="lead">Information about Reader </span></div>
                ...
                <form ng-submit="ctrl.submit()" name="readerForm" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="text" ng-model="ctrl.reader.tel" id="phone" class="form-control input-sm" placeholder="Enter your phone number" ng-pattern="/^[a-zA-Z0-9_ ]*$/" required/>
                            </div>
                        </div>
                    </div>
