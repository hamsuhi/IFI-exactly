...
public class MyController implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		manufactureService.updateManufacture(1, "Nga", "San xuat tai Thai lan");
		manufactureService.deleteManufacture(1);
		manufactureService.findManufactureById(2);
		log.info("_______________________________2. Lớp Model_____________________________________");
		Model m1 = modelService.addModel("20c/day", "N1", mf1);
		m1.toString();
		modelService.findAllModel();
		modelService.updateModel(1, "30c/ngay", "N1", mf1);
		...
		customerService.updtateCustomer(1, "Ha noi", "Viet Nam", "Huong", "nguyenhuong@gmail.com", "Nu", "013143743",
				"Cau Giay");
		customerService.deleteCustomer(0);
		customerService.findCustomerById(1);
		log.info("_______________________________6. Lớp Booking Status__________________________________");
